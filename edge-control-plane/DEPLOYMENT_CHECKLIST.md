...
- [ ] Create `modal_backend/security/cloudflare_auth.py` (requires `X-Internal-Auth` on all non-health endpoints)
- [ ] Copy implementation from `edge-control-plane/INTEGRATION.md`
- [ ] Update `modal_backend/api/controller.py` to use middleware
...
- [ ] Test locally: `modal run -m modal_backend.main`
- [ ] Deploy: `modal deploy -m modal_backend.deploy`
